...
if __name__=='__main__':
    ...
    parser.add_argument('--num', default=30, type=int, help='number of synthetic generations')
    ...
    parser.add_argument('--topk', default=100, type=int, help='k for top-k+ sampling; -1 for full vocabulary')
